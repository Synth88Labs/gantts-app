...
const CHROME = {
  en: {
    ...
    footer: { tagline: 'Free online Gantt chart maker. No account, no upload, your data stays in your browser.',
      ...
      privacy: 'Privacy', accessibility: 'Accessibility', about: 'About', editorial: 'Editorial standards', whatsnew: 'What’s new', rights: 'All rights reserved.' },
    langLabel: 'Language',
  ...
  es: {
    ...
    footer: { tagline: 'Creador de diagramas de Gantt gratis. Sin cuenta y sin subir nada: tus datos se quedan en tu navegador.',
      ...
      privacy: 'Privacidad', accessibility: 'Accesibilidad', about: 'Acerca de', editorial: 'Estándares editoriales', whatsnew: 'Novedades', rights: 'Todos los derechos reservados.' },
    langLabel: 'Idioma',
  ...
  fr: {
    ...
    footer: { tagline: 'Créateur de diagrammes de Gantt gratuit. Sans compte ni téléversement : vos données restent dans votre navigateur.',
      ...
      privacy: 'Confidentialité', accessibility: 'Accessibilité', about: 'À propos', editorial: 'Charte éditoriale', whatsnew: 'Nouveautés', rights: 'Tous droits réservés.' },
    langLabel: 'Langue',
  ...
  de: {
    ...
    footer: { tagline: 'Kostenloser Gantt-Diagramm-Generator. Ohne Konto, ohne Upload, Ihre Daten bleiben im Browser.',
      ...
      privacy: 'Datenschutz', accessibility: 'Barrierefreiheit', about: 'Über uns', editorial: 'Redaktionsstandards', whatsnew: 'Neuigkeiten', rights: 'Alle Rechte vorbehalten.' },
    langLabel: 'Sprache',
  ...
  pt: {
    ...
    footer: { tagline: 'Criador de gráfico de Gantt gratuito. Sem conta e sem upload, seus dados ficam no seu navegador.',
      ...
      privacy: 'Privacidade', accessibility: 'Acessibilidade', about: 'Sobre', editorial: 'Padrões editoriais', whatsnew: 'Novidades', rights: 'Todos os direitos reservados.' },
    langLabel: 'Idioma',
  ...
  zh: {
    ...
    footer: { tagline: '免费在线甘特图制作工具。无需注册、无需上传, , 数据只保存在你的浏览器中。',
      ...
      privacy: '隐私政策', accessibility: '无障碍', about: '关于我们', editorial: '编辑准则', whatsnew: '更新日志', rights: '保留所有权利。' },
    langLabel: '语言',
    skipToApp: '打开应用',
  },
};
...
const TEMPLATE_GROUPS = [
  ...
  { key: 'catTeam', slugs: ['marketing', 'content-calendar', 'employee-onboarding', '30-60-90-day-plan', 'product-roadmap', 'recruitment-hiring-plan', 'internal-audit-plan', 'iso-9001-certification-plan', 'soc2-compliance-timeline', 'call-center-setup-plan', 'okr-quarterly-planning', 'iso-27001-certification-plan', 'change-management-plan', 'iso-14001-certification-plan', 'qa-test-plan-schedule', 'iso-45001-certification-plan', 'customer-onboarding-plan'] },
