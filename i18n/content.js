...
const CHROME = {
  ...
  es: {
    ...
    footer: { tagline: 'Creador de diagramas de Gantt gratis. Sin cuenta y sin subir nada: tus datos se quedan en tu navegador.',
      ...
      privacy: 'Privacidad', accessibility: 'Accesibilidad', about: 'Acerca de', whatsnew: 'Novedades', rights: 'Todos los derechos reservados.' },
    langLabel: 'Idioma',
  ...
  fr: {
    ...
    footer: { tagline: 'Créateur de diagrammes de Gantt gratuit. Sans compte ni téléversement : vos données restent dans votre navigateur.',
      ...
      privacy: 'Confidentialité', accessibility: 'Accessibilité', about: 'À propos', whatsnew: 'Nouveautés', rights: 'Tous droits réservés.' },
    langLabel: 'Langue',
