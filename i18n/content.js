...
const TEMPLATE_GROUPS = [
  { key: 'catTypes', slugs: ['project-management', 'product-launch', 'event-planning', 'simple'
      /* 'research' lives in catAcademic only. It was listed in both,
         ...
         duplicate. The specific category wins over the generic one. */, '3-week-lookahead-template', 's-curve-template', 'cloud-migration-project-plan', 'new-product-development-plan', 'mobile-app-launch-plan', 'website-redesign-project-plan', 'nonprofit-fundraising-campaign', 'data-migration-project-plan', 'ma-due-diligence-timeline'] },
  { key: 'catIndustry', slugs: ['construction', 'software-development', 'home-renovation', 'wedding-planning'] },
  { key: 'catTeam', slugs: ['marketing', 'content-calendar', 'employee-onboarding', '30-60-90-day-plan', 'product-roadmap', 'recruitment-hiring-plan', 'internal-audit-plan', 'iso-9001-certification-plan', 'soc2-compliance-timeline', 'call-center-setup-plan', 'okr-quarterly-planning'] },
